...
class FusedMoEParallelConfig:
    ...
    @property
    def use_megakernel_kernels(self):
        return self.use_all2all_kernels and self.all2all_backend == "megakernel"
...
class FusedMoEConfig:
    ...
    @property
    def use_megakernel_kernels(self):
        return self.moe_parallel_config.use_megakernel_kernels
